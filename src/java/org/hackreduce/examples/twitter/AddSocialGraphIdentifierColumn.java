 ...
 *
 */
public class AddSocialGraphIdentifierColumn extends Configured implements Tool {
	...
	public static class AddSocialGraphIdentifierColumnMapper extends Mapper<LongWritable, Text, LongWritable, LongWritable> {
	...
	public static class AddSocialGraphIdentifierColumnReducer extends Reducer<LongWritable, Text, LongWritable, Text> {

		protected void reduce(LongWritable key, Iterable<LongWritable> values, Context context) throws IOException, InterruptedException {
			context.getCounter(Count.UNIQUE_KEYS).increment(1);
			//long count = 0;
			for (LongWritable value : values) {
				//context.write(key, new Text("22"));
			}
			context.write(key, new Text("22"));
		}
	...
	public int run(String[] args) throws Exception {
		...
		job.setReducerClass(AddSocialGraphIdentifierColumnReducer.class);
	...
	public static void main(String[] args) throws Exception {
		int result = ToolRunner.run(new Configuration(), new AddSocialGraphIdentifierColumn(), args);
		System.exit(result);
	}
