 ...
 *
 */
public class FollowingCounter extends Configured implements Tool {
	...
	public static class FollowingCounterMapper extends Mapper<LongWritable, Text, LongWritable, LongWritable> {
	...
	public static class FollowingCounterReducer extends Reducer<LongWritable, LongWritable, LongWritable, LongWritable> {
	...
	public int run(String[] args) throws Exception {
        ...
        job.setMapperClass(FollowingCounterMapper.class);
		job.setReducerClass(FollowingCounterReducer.class);
	...
	public static void main(String[] args) throws Exception {
		int result = ToolRunner.run(new Configuration(), new FollowingCounter(), args);
		System.exit(result);
	}
